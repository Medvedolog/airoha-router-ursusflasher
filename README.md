...
Сначала его не было. Первые версии UrsusFlasher работали поверх `tcboot` — загрузчика, который достался от вендора готовым двоичным файлом. Он работал, на живом железе это было подтверждено, и медведь на его веб-странице был нарисован. Но исходников у него не появилось, а значит нельзя было ни починить в нём ошибку, ни объяснить, что именно он делает с вашей NAND.
