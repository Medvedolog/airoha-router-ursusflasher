...
# AN7583 diagnostics, but expose no generic NAND/MTD/UBI persistent writer.
...
for sym in CONFIG_TARGET_AN7583 CONFIG_MTD CONFIG_DM_MTD CONFIG_MTD_SPI_NAND CONFIG_NET_LWIP CONFIG_AIROHA_ETH CONFIG_PCS_AIROHA_AN7583 CONFIG_PINCTRL_AIROHA_AN7583 CONFIG_PHY_AIROHA_EN8811 CONFIG_ENV_IS_NOWHERE CONFIG_CONSOLE_RECORD; do
...
printf '%s\n' \
  ...
  "HTTP_POST=REJECTED" \
  "ENV=NOWHERE" > "$OUT/MF2-BUILD_INFO.txt"
