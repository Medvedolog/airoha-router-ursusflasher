...
STALE = {
    ...
    "md": ("data/payloads/md/ursusboot", ("*TEST61*.fip", "*TEST62*.fip", "*TEST63*.fip", "*TEST61*-u-boot.bin", "*TEST63*-u-boot.bin", "*TEST63*.bin", "*UBIUX1-TEST64*", "*-alpha5-t64-*", "*-alpha5-t65-*")),
    "mf": ("data/payloads/mf/recovery", ("*TEST61*", "*TEST62*", "*TEST63*", "*UBIUX1-TEST64*", "*-alpha5-t64-*", "*-alpha5-t65-*")),
}
