...
def main()->int:
    ...
    runtime=checked(ns.runtime); fip=checked(ns.fip); preloader=checked(ns.preloader)
    ...
    payload={
      ...
      "contracts":{"production_child_exact_manifest_bytes":True,"runtime_fit_has_no_untracked_tail":True,"bl2_written_last_by_stage2":True,"identity_restore_required":True,"single_operator_confirmation":True,"hw_status":"HW_PENDING"}
    }
