...
assert transition.index("pb.backup_tftp(") < transition.index("destructive boundary")
...
assert transition.index("_select_and_preflight_transport(") < transition.index(prompt)
assert transition.index(prompt) < transition.index("# ---------------- destructive boundary ----------------")
